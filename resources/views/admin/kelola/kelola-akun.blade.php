...
@section('content')
    ...
    <form method="GET" id="accountFilter" class="filter-section">
        ...
        <div class="filter-left">
            ...
            <button type="button" class="btn-refresh" onclick="location.href='{{ route('admin.manage-account.index') }}'">
                                    ...
                                    <td>
                                        <div class="email-wrapper">
                                            ...
                                            @if ($user->hasVerifiedEmail())
                                                <span class="email-status verified" title="Email sudah diverifikasi">

                                                    <i class="fa-solid fa-check"></i>

                                                </span>
                                            @else
                                                <span class="email-status unverified" title="Email belum diverifikasi">
                    ...
                    <div class="custom-pagination">
                        ...
                        <div class="pagination-right">
                            ...
                            @for ($page = $start; $page <= $end; $page++)
                                ...
                                @else
                                    <a href="{{ $users->url($page) }}" class="page-number">
