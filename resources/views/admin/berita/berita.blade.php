...
@section('content')
        ...
        <table class="berita-table">
            ...
            <tbody>
                ...
                @forelse($news as $index => $item)
                    <tr data-title="{{ strtolower($item->title) }}" data-category="{{ $item->category_id }}">
                            <td>
                        ...
                        <td>
                            ...
                            @else
                                <img src="{{ asset('assets/no-image.png') }}" alt="No Image" class="table-thumbnail">
                            @endif
                        </td>
    ...
    <div class="modal" id="formModal">
        ...
        <div class="modal-content modal-large">
            ...
            <form id="beritaForm" action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
